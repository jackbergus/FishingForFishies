...
public class MoveFish : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        minY = GameObject.Find("PoolFloor").transform.position.y;
        maxY = GameObject.Find("Water4Advanced").transform.position.y;
        minZ = GameObject.Find("LeftMargin").transform.position.z;
        maxZ = GameObject.Find("RightMargin").transform.position.z;
        minX = GameObject.Find("FrontMargin").transform.position.x;
        maxX = GameObject.Find("BackMargin").transform.position.x;
    ...
    Quaternion fromAngle = new Quaternion();
    Quaternion toAngle = new Quaternion();
    ...
    void Update()
    {
        ...
        if ((prevAction == null) && (currAction == null))
        {
            ...
            if ((m_RigidBody.position.y + 2.0) >= maxY)
            {
                hasChangeDir = true;
                changeDir += down;
            }
